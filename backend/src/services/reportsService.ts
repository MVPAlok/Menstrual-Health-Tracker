...
<head>
  <meta charset="UTF-8">
  <title>NariCare Health Report - ${userName}</title>
  <style>
    :root {
      --primary: #a53556;
      --secondary: #64748b;
  ...
  <div class="container">
    ...
    <div class="header">
      <div class="logo-container">
        ...
        <div class="logo-text">NariCare</div>
      </div>
      <div class="meta-info">
    ...
    <div class="footer">
      This document contains private physiological tracking telemetry generated by NariCare's biometric engine.
      <br>
      <strong>NariCare &copy; 2026. All medical insights are derived from user-submitted logs.</strong>
    </div>
  </div>
</body>
</html>
